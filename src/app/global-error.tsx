...
export default function GlobalError({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <html lang="en">
      <body className="min-h-screen flex items-center justify-center bg-gradient-to-b from-amber-50 to-orange-50 p-4">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
          ...
          <p className="text-amber-600/70 text-sm mb-6">An unexpected error occurred. Please try again.</p>
